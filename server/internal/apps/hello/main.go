...
func main() {
	...
	protocol := config.GetString("HelloApp.Prot")
	address := config.GetString("HelloApp.Addr")
	...
	hello.RegisterTesterServer(gameServer, hello.HelloService{})
